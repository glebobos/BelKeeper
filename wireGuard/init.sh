...
PARAMETER_OVERRIDES="--parameter-overrides Environment=${ENVIRONMENT} VpcId=$VPC_ID SubnetIds=$SUBNET_IDS"
...
if [[ "$DELETE_STACK" == true ]]; then
    ...
    read -p "Press any key to continue with stack deletion..." -n 1 -r
